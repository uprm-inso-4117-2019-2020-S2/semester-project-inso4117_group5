...
class UserHandlerTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.r1 = ['Toilet Paper', 'this is NOT a description', 'home', 'Requesting', 1]
        self.r2 = ['Hand Sanitizer', 'this MAY be a decription', 'Maya', 'Provided', 3]
        self.r3 = ['Food', 'this is POSSIBLY a description', 'laCalle', 'Provided', 1]
        self.r4 = ['send help pls', 'this is ME DOING a description', 'casa', 'Requesting', 3]
        self.r5 = ['beer', 'this is JUST a description', 'bar', 'Requesting', 4]

        keys = ['rtitle', 'rdescription', 'rlocation', 'rstatus', 'ruser']
